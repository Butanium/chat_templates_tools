...
with open(template_path / "legacy/customizable_gemma_chat_template.jinja", "r") as f:
    CUSTOMIZABLE_GEMMA_CHAT_TEMPLATE = f.read()
with open(
    template_path / "legacy/customizable_gemma_chat_template_ctrl_tokens.jinja", "r"
) as f:
...
def custom_chat_template(
    ...
    *,
    ...
    if ctrl_tokens:
        ...
        template = CUSTOMIZABLE_GEMMA_CHAT_TEMPLATE
    template = (
